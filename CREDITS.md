...
SwarmVault's skills were **written fresh** — no text copied — but the techniques were
learned from these authors' work. Thank you. (Licenses recorded as found at merge time;
"none published" means we could not locate one — corrections welcome via issue/PR.)
